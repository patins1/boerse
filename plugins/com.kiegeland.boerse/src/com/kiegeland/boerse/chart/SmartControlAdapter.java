...
/**
 * This is an extended version of the regular ControlAdapter. It is used to get only the real resize events and excludes all resize events of the text size determination.
 * 
 */
public abstract class SmartControlAdapter extends ControlAdapter {
	...
	public void controlResized(ControlEvent e) {
		...
		Point previousSize = (Point) e.widget.getData("previousShellSize" + this.hashCode());
